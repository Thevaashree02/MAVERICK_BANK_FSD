...
function ManagerSidebar({ setIsClosed, overlayRef, wrapperRef }) {
                ...
                <ul className="nav sidebar-nav">
                    ...
                    <li>
                        <Link to="/manager" onClick={handleLinkClick}>
                            <i className="bi bi-bank2" style={{ marginRight: "10px" }}></i>
                            My Bank
                        </Link>
                    </li>
                    <li>
                        <Link to="/manager/branch" onClick={handleLinkClick}>
                            <i className="bi bi-building" style={{ marginRight: "10px" }} />
                            Branch
                        </Link>
                    </li>
                    <li>
                        <Link to="/manager/accounts" onClick={handleLinkClick}>
                            <i className="bi bi-safe" style={{ marginRight: "10px" }} />
                            Accounts
                        </Link>
                    </li>
                    <li>
                        <Link to="/manager/transactions" onClick={handleLinkClick}>
                            <i className="bi bi-currency-exchange" style={{ marginRight: "10px" }} />
                            Transactions
                        </Link>
                    </li>
                    <li>
                        <Link to="/manager/loans" onClick={handleLinkClick}>
                            <i className="bi bi-cash-stack" style={{ marginRight: "10px" }} />
                            Loans
                        </Link>
                    </li>
                    <li>
                        <Link to="/manager/profile" onClick={handleLinkClick}>
